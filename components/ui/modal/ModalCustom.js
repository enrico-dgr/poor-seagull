...
const ModalCustom = (props) => {
	...
	const setPlayerNum = (num) => () =>
		setState((prev) => ({ ...prev, playerNum: Number(num) }));
					...
					<View style={style.viewPlayersNumber}>
						<View style={style.viewButtonsCircles}>
							<PressableCircle
								buttonText="2"
								buttonStyle={
									state.playerNum === 2 && { backgroundColor: "red" }
								}
							...
							<PressableCircle
								buttonText="4"
								buttonStyle={
									state.playerNum === 4 && { backgroundColor: "red" }
								}
							...
							<PressableCircle
								buttonText="8"
								buttonStyle={
									state.playerNum === 8 && { backgroundColor: "red" }
								}
							...
							<PressableCircle
								buttonText="16"
								buttonStyle={
									state.playerNum === 16 && { backgroundColor: "red" }
								}
